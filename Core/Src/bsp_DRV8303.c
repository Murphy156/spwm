...
void DRV8303_Init(void)
{
    ...
    SPI_WRITE_MODE1 = DRV8303_Write_Mode|DRV8303_Control_Reg1|DRV8303_GATE_CURRENT_1_7|DRV8303_GATE_RESET_Normal
                      |DRV8303_PWM_MODE_6|DRV8303_OCP_MODE_OC_Latch_Shut_Down|DRV8303_OC_ADJ_SET_0_822;
